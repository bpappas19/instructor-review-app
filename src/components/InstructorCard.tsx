...
const InstructorCard = ({ instructor }: InstructorCardProps) => {
  return (
    <Link
      ...
      className="flex flex-col gap-4 rounded-lg bg-white dark:bg-surface-dark p-4 shadow-sm border border-border-light dark:border-border-dark hover:shadow-md transition-shadow"
    >
      <img
